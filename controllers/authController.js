...
const transporter = nodemailer.createTransport({
    service: 'gmail', // Recommended for simple setup; use App Passwords for Gmail
    auth: {
...
const registerUser = asyncHandler(async (req, res) => {
    // Destructure body and normalize email to prevent duplication
...
const forgotPassword = asyncHandler(async (req, res) => {
    ...
    // Rate Limiting Logic: Reset count if 24 hours have passed
    const now = new Date();
    ...
    user.resetPasswordExpires = Date.now() + 10 * 60000; // 10 minutes expiry
